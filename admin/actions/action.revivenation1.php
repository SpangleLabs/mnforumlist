<form action="action.revivenation2.php" method="post">
NationID: <select name="NatID">
<?
include('../../connect.php');
$raw_nations = mysql_query('SELECT `NatID`,`Name` FROM `'.$db_pre.'data` WHERE `Status` = \'Dead\' ORDER BY `Name`');
...
<input type="submit" value="Revive nation" />
</form>