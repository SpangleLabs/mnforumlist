...
echo(function_check_forumnumber($dat_nations['NatID'],$db_pre,0));
echo(function_check_mapnumber($dat_nations['NatID'],$db_pre,0));
echo(function_check_lognumber($dat_nations['NatID'],$db_pre,0));
echo(function_check_culturefolder($dat_nations['NatID'],$db_pre,0));
echo(function_check_culturenumber($dat_nations['NatID'],$db_pre,0));
echo(function_check_PPD($dat_nations['NatID'],$db_pre,0));
echo(function_check_rating($dat_nations['NatID'],$db_pre,0));
echo(function_check_flags($dat_nations['NatID'],$db_pre,0));
...
<a href="index_fix.php">Click here</a> to fix all the problems.
